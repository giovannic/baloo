...
\section{Company Structure and Management Profiles}
  ...
  \subsection{The Team}
  \includegraphics[width=80px]{john.jpg} \textbf{John Walker, Chief Executive Officer}\\
  \includegraphics[width=80px]{adam.jpg} \textbf{Adam Fiksen, Chief Operating Officer Officer}\\
  \includegraphics[width=80px]{rutwik.jpg} \textbf{Rutwik Shah, Chief Financial Officer}\\
  \includegraphics[width=80px]{sahil.jpg} \textbf{Sahil Jain, Chief Brand Officer}\\
  \includegraphics[width=80px]{gio.jpg} \textbf{Giovanni Charles, Chief Technical Officer}\\
  \includegraphics[width=80px]{alina.jpg} \textbf{Alina Boghiu, Founder}\\
  \includegraphics[width=80px]{lukasz.jpg} \textbf{Lukasz Koprowski, Founder}\\
